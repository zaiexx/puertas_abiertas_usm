...
@section('content')
    ...
    <div class="container-fluid">
        <div class="block-header">
            <h2>Panel de Administración | Inscripcion de Talleres y Rutas de {{ $alumno->rut }}</h2>
        </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 curso">
                        <div class="card">
                            ...
                            @endif
                                    ...
                                    <span class="badge" act-id="{{$actividad->id_actividad_evento}}">{{$actividad->cuposTotales()}}</span>
